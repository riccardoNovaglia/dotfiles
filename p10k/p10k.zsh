# Generated by Powerlevel10k configuration wizard on 2023-08-23 at 09:16 BST.
...
() {
  ...
  function prompt_fnm() {
    ...
    local fnm_current=$(fnm current | cut -d '.' -f 1)
    [[ $fnm_default != $fnm_current ]] || return
    p10k segment -b 'magenta' -f 'green' -i 'NODE_ICON' -r -t "$fnm_current"
  }
